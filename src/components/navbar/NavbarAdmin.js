...
{/* 					<Breadcrumb>
					...
					<Flex me={openSidebar ? "" : "5"} mx={openSidebar ? "14" : "1"} display={{ sm: "none", xl: "flex" }}>
						<Image
							style={{ width: openSidebar ? "120px" : "52px", height: '52px', objectFit: "cover" }}
							src="https://res.cloudinary.com/dna3hwzre/image/upload/v1741499065/473408572_1590238345196986_2661325784945347044_n_ii9ax7.jpg" // Set the source path of your image
